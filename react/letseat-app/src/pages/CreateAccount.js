...
function CreateAccount() {
    ...
    const fetchQuestions = async () => {
        ...
        const response = await fetch("http://ec2-54-160-112-17.compute-1.amazonaws.com:8000/questionnaire/createprofile/", requestOption)
    ...
    const submitSelections = async (e) => {
        ...
        if (checkInputSubmissions() == 1) {
            ...
            await fetch("http://ec2-54-160-112-17.compute-1.amazonaws.com:8000/createprofile", requestOption)
                .then(async response => {
