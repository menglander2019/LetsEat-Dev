...
function CreateAccount() {
    ...
    const fetchQuestions = async () => {
        ...
        const response = await fetch("http://ec2-3-84-237-203.compute-1.amazonaws.com:8000/questionnaire/createprofile/", requestOption)
    ...
    const submitSelections = async (e) => {
        ...
        if (checkInputSubmissions() == 1) {
            ...
            await fetch("http://ec2-3-84-237-203.compute-1.amazonaws.com:8000/createprofile", requestOption)
                .then(async response => {
