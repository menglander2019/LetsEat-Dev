...
function ProfileQuestions() {
    ...
    const fetchQuestions = async () => {
        ...
        await fetch("http://ec2-54-160-112-17.compute-1.amazonaws.com:8000/questionnaire/profile/", requestOption)
            .then(async response => {
    ...
    const submitSelections = async (e) => {
        ...
        await fetch("http://ec2-54-160-112-17.compute-1.amazonaws.com:8000/submit/profile/", requestOption)
            .then(async response => {
                const data = await response.json()
