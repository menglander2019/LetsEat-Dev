...
const JoinGroup = () => {
    ...
    const getHostUsername = async () => {
        ...
        const response = await fetch("http://ec2-52-86-251-227.compute-1.amazonaws.com:8000/getGroupHostName", requestOption)
            .then(async response => {
    ...
    const submitSelections = (e) => {
        ...
        const response = fetch("http://ec2-52-86-251-227.compute-1.amazonaws.com:8000/joinGroup/", requestOption)   
            .then(response => {
                if (response.ok) {
