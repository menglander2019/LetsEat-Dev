...
const JoinGroup = () => {
    ...
    const getHostUsername = async () => {
        ...
        const response = await fetch("http://ec2-3-84-237-203.compute-1.amazonaws.com:8000/getGroupHostName", requestOption)
            .then(async response => {
    ...
    const fetchQuestions = async () => {
        ...
        const response = await fetch("http://ec2-3-84-237-203.compute-1.amazonaws.com:8000/questionnaire/profile/", requestOption)
            .then(async response => {
                const data = await response.json()
                if (response.ok) {
                    setQuestions(data)
    ...
    const submitSelections = (e) => {
        ...
        const response = fetch("http://ec2-3-84-237-203.compute-1.amazonaws.com:8000/joinGroup/", requestOption)   
            .then(response => {
                if (response.ok) {
