...
const JoinGroup = () => {
    ...
    const getHostUsername = async () => {
        ...
        const response = await fetch("http://ec2-54-165-70-250.compute-1.amazonaws.com:8000/getGroupHostName", requestOption)
            .then(async response => {
    ...
    const submitSelections = (e) => {
        ...
        const response = fetch("http://ec2-54-165-70-250.compute-1.amazonaws.com:8000/joinGroup/", requestOption)   
            .then(response => {
                if (response.ok) {
